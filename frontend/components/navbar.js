...
const Navbar = () => {
    ...
    return (
      <div className='flex flex-row justify-between items-center min-w-full px-5 bg-transparent py-2'>
          <a href="/"> <Image src={Groovewave} alt='Navbar' /> </a>
          <div>
              <button className='hidden md:block bg-[#F5F5F5] text-black font-bold hover:bg-[#253646] hover:text-white py-2 px-5 mt-2 md:mt-0 rounded-xl'><a href='/login'>Login</a></button>
