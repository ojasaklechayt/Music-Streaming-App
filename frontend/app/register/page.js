                ...
                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                  ...
                  <form className="space-y-4 md:space-y-6">
                    <div>
                      ...
                      <input
                        ...
                        name="username"
                        id="username"
                        className="bg-[#3A6A70] text-white placeholder-gray-300 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                    ...
                    <button
                      ...
                      className="w-[50%] bg-white text-black font-bold rounded-md py-2 mt-7 px-3 sm:px-4 duration-50 text-sm sm:text-base font-poppins hover:bg-gray-300 hover:cursor-pointer transition duration-300 ease-in-out"
                    >
                      Register
                    </button>
                  </form>
                  ...
                  <Link href="/login">
                    <p className="font-poppins text-center z-10">
                      <span
                        className="text-[#3AE7FF] hover:cursor-pointer hover:underline"
                        style={{ zIndex: 10 }}
                      >
                        Login Now!
                      </span>
